...
RSpec.describe Hyrax::Orcid::Profile::WorkPresenter do
  ...
  let(:record_response_body) { File.read Rails.root.join("..", "fixtures", "orcid", "json", "reader_service_record.json") }
  let(:works_response_body) { File.read Rails.root.join("..", "fixtures", "orcid", "json", "reader_service_works.json") }
